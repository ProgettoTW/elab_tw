     ...
     <div class="container py-5">
         <div class="row">
             <div class="col-md-6 px-md-5">
                 ...
                 <p class="lead mb-4">Rilassati con qualche dolce!<br></p> <a href="#" class="btn btn-lg btn-primary">Vai allo Shop!</a>
             </div>
         ...
         <div class="row">
             ...
             <div class="col-md-6">
                 <div class="px-md-5 p-3 col-md-12 d-flex flex-column align-items-start justify-content-center">
                     <h1>Lorem Ipsum</h1>
                     <p class="mb-3 lead">Boh non so che scrivere qui... Aggiungiamo qualche descrizione? Qualche aiuto per scegliere i dolci?</p>
                     <div class="row">
         ...
         <div class="container text-center text-md-start mt-5">
             <div class="row mt-3">
                 <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                     ...
                     <p> Compagnia di consegna di dolci per studenti e docenti presso l'Alma Mater Studiorum - Università di Bologna - Campus di Cesena <br> <br> Scopri centinaia di prodotti artigianali prodotti dalle migliori Pasticcerie della zona. <br> <br> Inserisci la data di nascita corretta, al tuo compleanno riceverai una torta da gustare con chi vuoi! </p>
                 </div>
 ...
 <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous" style=""></script>
 </body>
