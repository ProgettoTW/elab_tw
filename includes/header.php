    ...
    <nav class="navbar navbar-expand-lg text-uppercase navbar-dark">
        ...
        <div class="collapse navbar-collapse justify-content-lg-between" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav auth">
                <li class="nav-item">
                    <a href="login_page.php"><button type="button" class="btn btn-primary">Accedi</button></a>
                </li>
                <li class="nav-item">
                    <a href="register_page.php"><button type="button" class="btn btn-secondary">Registrati</button></a>
                </li>
            </ul>
                <?php
            } ?>
