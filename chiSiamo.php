    ...
    <div class="row">
        ...
        <div class="col-lg-8 my-lg-0 my-1">
            <div class="d-flex flex-column div-presentazione">
                ...
                <p>Il progetto consiste nella realizzazione di una piattaforma di Delivery di torte e prodotti di
                    pasticceria nel Campus di
                    Cesena.<br>Il nome della piattaforma è <em><b>Pastecceroo</b></em>.<br><br>La piattaforma
                    permette ai clienti di:</p>
                ...
                <p>Ogni volta che un <b>Cliente</b> effettua un ordine si attiva un sistema simulato di notifiche che lo
                    tiene aggiornato sullo stato dell'ordine e tramite il quale, una volta ricevuto il prodotto, può
                    confermare la ricezione del medesimo.</br>Queste notifiche appaiono anche al <b>Venditore</b> ogni
                    volta che arriva la richiesta di un ordine e che viene confermata la sua consegna. Inoltre, il
                    venditore riceve notifiche ogni volta che un suo prodotto termina nel magazzino.</p>

                <p>Tutti i <a href="https://www.figma.com/file/fjFtReDUXLz3AsotjEdGGv/Untitled?node-id=1%3A4">Mockup</a>
                    sono stati realizzati in Figma (seguire il link per visualizzarli), inoltre all'interno del progetto
                    sono state utilizzate varie risorse esterne come:
                    <a href="https://drawkit.com/">Drawkit</a>, <a href="https://icons.getbootstrap.com/">Bootstrap
                        Icon</a>, <a href="https://undraw.co/illustrations">UnDrow</a>, <a href="https://unsplash.com/">UnSplash</a>
                    e tanti altri.
                </p>
            </div>
        </div>
